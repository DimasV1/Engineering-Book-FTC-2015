	...
	\begin{enumerate}
        ...
        \begin{figure}[H]
	  	  \begin{minipage}[h]{0.31\linewidth}
	  	    \center{\includegraphics[scale=0.3]{days/06.02.15/images/02}}
	  	    \caption{Start position}
	  	  \end{minipage}
	  	  \hfill
	  	  \begin{minipage}[h]{0.31\linewidth}
	  		\center{\includegraphics[scale=0.31]{days/06.02.15/images/03}}
	  		\caption{Intermediate position}
	  	  \end{minipage}
	  	  \hfill
	  	  \begin{minipage}[h]{0.31\linewidth}
	  	   	\center{\includegraphics[scale=0.32]{days/06.02.15/images/04}}
