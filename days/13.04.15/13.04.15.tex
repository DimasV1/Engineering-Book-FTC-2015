...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Also we looked a variant to install Lefo caterpillars on the wheels but we decided that construction with omni-wheels is better because robot with omni-wheels can turn faster and more accurate.
