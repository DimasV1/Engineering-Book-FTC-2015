	...
	\begin{enumerate}
		...
		\begin{figure}[H]
			\begin{minipage}[h]{0.47\linewidth}
				\center{\includegraphics[scale=0.25]{days/24.03.15/images/01}}
			\end{minipage}
			\hfill
			\begin{minipage}[h]{0.47\linewidth}
        ...
        \begin{figure}[H]
	  	  ...
	  	  \hfill
	  	  \begin{minipage}[h]{0.47\linewidth}
	  		\center{\includegraphics[scale=0.3]{days/24.03.15/images/04}}
	   ...
	   \begin{figure}[H]
	   	...
	   	\begin{minipage}[h]{0.6\linewidth}
	   		\center{\includegraphics[scale=0.4]{days/24.03.15/images/05}}
	   		\caption{}
	   	\end{minipage}
	   \end{figure}
