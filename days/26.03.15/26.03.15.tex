	...
	\begin{enumerate}
		...
		\begin{figure}[H]
			...
			\begin{minipage}[h]{0.6\linewidth}
				\center{\includegraphics[scale=0.3]{days/26.03.15/images/01}}
				\caption{}
			\end{minipage}
		\end{figure}
        ...
        \begin{figure}[H]
        	...
        	\end{minipage}
        	\begin{minipage}[h]{0.6\linewidth}
        		\center{\includegraphics[scale=0.3]{days/26.03.15/images/02}}
        		\caption{}
        	\end{minipage}
        \end{figure}
        ...
        \begin{figure}[H]
        	...
        	\end{minipage}
        	\begin{minipage}[h]{0.6\linewidth}
        		\center{\includegraphics[scale=0.3]{days/26.03.15/images/03}}
        		\caption{}
        	\end{minipage}
        \end{figure}
