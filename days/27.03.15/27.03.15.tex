...
\begin{enumerate}
	...
	\begin{figure}[H]
		...
		\begin{minipage}[h]{0.6\linewidth}
			\center{\includegraphics[scale=0.7]{days/27.03.15/images/01}}
	...
	\begin{figure}[H]
		...
		\end{minipage}
		\begin{minipage}[h]{0.6\linewidth}
			\center{\includegraphics[scale=0.7]{days/27.03.15/images/02}}
	...
	\begin{figure}[H]
		...
		\end{minipage}
		\begin{minipage}[h]{0.6\linewidth}
			\center{\includegraphics[scale=0.3]{days/27.03.15/images/03}}
